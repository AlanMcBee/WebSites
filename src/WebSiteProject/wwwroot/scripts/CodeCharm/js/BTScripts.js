(function () {
    (function (d) {
        var f = false; function e() {
            ...
            if (!("innerWidth" in window)) { b = "client"; a = document.documentElement || document.body }
        ...
        showMegaMenu = function (L, J, c, y) {
            ...
            if (d(c).children("ul").is(".submenu")) {
                ...
                if (J.Orientation.toLowerCase() == "vertical") {
                    ...
                    if (I > 0 && d(c).hasClass("mega")) { F.css("margin-left", "-" + I + "px") }
                    var B = d(c).find("a,span").offset().top - d(c).offset().top;
                    if (B > 0) { F.css("margin-top", B + "px") }
                    ...
                    if (J.Orientation.toLowerCase() == "horizontal") {
                        ...
                        var C = D - E - b;
                        if (E + b + z > D) { var x = K - b - C; F.css("left", "-" + x + "px") }
                        else {
        ...
        megaMenuWithColumns = function (v, t, C, A, y, B, b, z, a) {
            ...
            else { for (var u = 0; u < D.length; u += t) { D.slice(u, u + t).wrapAll("<div class='megamenu-row'></div>") } }
            C.css("width", a * t + "px");
        ...
        d.fn.BindMENU = function (a) {
            ...
            var A = "toggle"; var z = "768";
            if (a.Speed != null) { y = a.Speed.toLowerCase() }
                ...
                d(".mega > .submenu", this).each(function () {
                    ...
                    d("li", this).each(function () {
                        if (d(this).width() > b) {
                            ...
                            if (b > a.MaxWidth) { b = a.MaxWidth; d(".menu-item-text", this).css("white-space", "normal") }
                            else {
