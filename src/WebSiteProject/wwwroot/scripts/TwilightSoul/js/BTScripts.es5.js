...
(function () {
    (function (d) {
        var f = false;function e() {
            var a = window,
                b = "inner";if (!("innerWidth" in window)) {
        ...
        showDefaultMenu = function (a, n, c, b) {
            ...
            if (d(c).find("ul").is(".submenu")) {
                ...
                if (n.Orientation.toLowerCase() == "vertical" || d(c).parent().is(".submenu")) {
                    ...
                    var m = d(c).children("a,span").offset().left - d(c).offset().left;if (m > 0) {
        ...
        showAccordionMenu = function (a, h, c, b) {
            if (h.Event == "hover") {
                ...
                if (d("ul.submenu", c).is(".submenu")) {
                    d(c).children("ul").slideDown(b).css({ position: "relative", display: "block" });
                }
            }
        ...
        showMegaMenu = function (L, J, c, y) {
            ...
            if (d(c).children("ul").is(".submenu")) {
                ...
                if (J.Orientation.toLowerCase() == "vertical") {
                    ...
                    var I = d(c).find("a,span").offset().left - d(c).offset().left;if (I > 0 && d(c).hasClass("mega")) {
                        F.css("margin-left", "-" + I + "px");
                    }
                    var B = d(c).find("a,span").offset().top - d(c).offset().top;if (B > 0) {
                    ...
                    if (J.Orientation.toLowerCase() == "horizontal") {
                        ...
                        var C = D - E - b;if (E + b + z > D) {
                            var x = K - b - C;F.css("left", "-" + x + "px");
                        } else {
                            if (z > E) {
                                F.css("left", "-" + E + "px");
                            } else {
        ...
        megaMenuWithColumns = function (v, t, C, A, y, B, b, z, a) {
            ...
            if (z == "vertical") {
                ...
                var x = d(".container").width() - c - w;if (v > A) {
                    A = x - i;
                } else {
                    A = v;
                }
            ...
            if (c == "select") {
                ...
                if (c == "toggle") {
                    d("li > ul", a).each(function () {
                        ...
                        if (g.find(".sf-sub-indicator").length <= 0) {
                            g.append('<em class="sf-sub-indicator closed"></em>');
                        } else {
                            g.find(".sf-sub-indicator").removeClass("opened").addClass("closed");
                        }
                    });
        ...
        d.fn.BindMENU = function (a) {
            ...
            var A = "toggle";var z = "768";if (a.Speed != null) {
            ...
            if (a.MenuStyle.toLowerCase() == "megamenu") {
                ...
                d(".mega > .submenu", this).each(function () {
                    var g = 0;d(this).children("li").each(function () {
                        g++;
                    });
                    d("li", this).each(function () {
                        if (d(this).width() > b) {
                            ...
                            b = d(this).width() + q + p + o + n;if (b > a.MaxWidth) {
                                b = a.MaxWidth;d(".menu-item-text", this).css("white-space", "normal");
                            } else {
                                if (b < a.MinWidth) {
                                    b = a.MinWidth;
                                } else {
                    ...
                    var l = d(".container").width() + j + h;if (a.MaxColumns && a.MaxColumns > 0 && a.MaxColumns <= g) {
                        ...
                        d(window).resize(function () {
                            if (d(window).width() >= z) {
                                ...
                                var n = parseInt(d(".container").css("padding-right").split("px")[0]);
                                var p = d(".container").width() + o + n;megaMenuWithColumns(m, parseInt(a.MaxColumns), i, p, true, a.MinWidth, a.MaxWidth, a.Orientation, b);
                            } else {
            ...
            if (a.Orientation.toLowerCase() == "vertical") {
                ...
                d(window).resize(function () {
                    if (e().width <= 991) {
                        ...
                        switch (r) {
                            case "accordion":
                                a.MenuStyle = "Accordion";B.closest("#MenuV").addClass("accordion");
                                eventOpenAccordionMenu(B);
                                break;case "defaultmenu":
                                a.MenuStyle = "DefaultMenu";d("ul.submenu", B).css("position", "absolute");
                                d("ul.submenu", B).each(function () {
                                    d(this).css("min-width", "180px");
                                });
                                eventOpenDefaultMenu(B, this, a, y);
                                break;case "megamenu":
                                a.MenuStyle = "MegaMenu";B.closest("#MenuV").addClass("megamenu");
