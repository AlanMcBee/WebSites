...
GO
CREATE NONCLUSTERED INDEX [IX_umbracoLog_datestamp]
    ON [dbo].[umbracoLog]([Datestamp] ASC, [userId] ASC, [NodeId] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_umbracoLog_datestamp_logheader]
    ON [dbo].[umbracoLog]([Datestamp] ASC, [logHeader] ASC);
