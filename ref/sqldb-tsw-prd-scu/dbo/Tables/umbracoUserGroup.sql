CREATE TABLE [dbo].[umbracoUserGroup] (
    ...
    [key]                         UNIQUEIDENTIFIER CONSTRAINT [DF_umbracoUserGroup_key] DEFAULT (newid()) NOT NULL,
...
GO
CREATE UNIQUE NONCLUSTERED INDEX [IX_umbracoUserGroup_userGroupKey]
    ON [dbo].[umbracoUserGroup]([key] ASC);
